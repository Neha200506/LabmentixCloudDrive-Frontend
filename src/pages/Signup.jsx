      ...
      <div className="w-full max-w-md z-10 my-8">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-8 shadow-2xl shadow-black/40">
          <div className="mb-6">
            ...
            <p className="text-slate-400 text-sm mt-1">Get started with 15GB free storage today</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2 rounded-xl bg-slate-950/60 border ${
                    errors.name ? 'border-rose-500/50 focus:border-rose-500 focus:ring-rose-500/20' : 'border-slate-800 focus:border-indigo-500 focus:ring-indigo-500/20'
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-10 pr-10 py-2 rounded-xl bg-slate-950/60 border ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-10 pr-10 py-2 rounded-xl bg-slate-950/60 border ${
                    errors.confirmPassword ? 'border-rose-500/50 focus:border-rose-500 focus:ring-rose-500/20' : 'border-slate-800 focus:border-indigo-500 focus:ring-indigo-500/20'
                  } text-white placeholder-slate-500 focus:outline-none focus:ring-4 transition duration-200`}
                />
                <button
                  type="button"
